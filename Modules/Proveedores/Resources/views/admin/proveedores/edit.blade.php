...
@section('content-header')
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">{{ trans('proveedores::proveedores.title.edit proveedores') }}</li>
    </ol>
@stop
...
@section('content')
    {!! Form::open(['route' => ['admin.proveedores.proveedores.update', $proveedores->id], 'method' => 'put', 'id' => 'formulario']) !!}
    <div class="row">
        <div class="col-md-12">
                ...
                <div class="tab-content">
                    ...
                    @foreach (LaravelLocalization::getSupportedLocales() as $locale => $language)
                        ...
                        <div class="tab-pane {{ locale() == $locale ? 'active' : '' }}" id="tab_{{ $i }}">
                            @include('proveedores::admin.proveedores.partials.edit-fields', ['lang' => $locale])
                        </div>
                    @endforeach
